...
INSERT INTO `appointments` VALUES (1,'2021-03-15 00:12:43','1:30h',1500,1,1),(4,'2021-07-08 03:15:00','1h',1500,2,2),(5,'2021-07-08 11:25:00','1.5h',1700,1,2),(6,'2021-07-14 00:14:00','2h',1900,7,1);
...
--
-- Table structure for table `cliniccentaradmins`
--

DROP TABLE IF EXISTS `cliniccentaradmins`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `cliniccentaradmins` (
  `cliniccentaradmin_id` int NOT NULL AUTO_INCREMENT,
  `user_id` int DEFAULT NULL,
  PRIMARY KEY (`cliniccentaradmin_id`),
  KEY `cliniccenteradmin_fk_idx` (`user_id`),
  CONSTRAINT `cliniccenteradmin_fk` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `cliniccentaradmins`
--

LOCK TABLES `cliniccentaradmins` WRITE;
/*!40000 ALTER TABLE `cliniccentaradmins` DISABLE KEYS */;
INSERT INTO `cliniccentaradmins` VALUES (1,51);
/*!40000 ALTER TABLE `cliniccentaradmins` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `users` VALUES (8,'Ivan','Ivankovic','ivan@gmail.com','Pupinova 22','$2a$10$5u9m3W2O8.SZ890EhSI5aeNL3RfIRtUZKa0J/4SgkpWi9ofC.rRQe','Novi Sad','Srbija','012121',1,_binary ''),(9,'Slavko','Milic','slavko@gmail.com','Njegoseva 21','$2a$10$HalcBrrcxf77zdfE6zHnyegXc3qK/NbXlvwtjVZi6WB2pLE7/gej6','Loznica','Srbija','01212321',1,_binary '\0'),(20,'Milena','Dravic','milena@gmail.com','Pop Lukina 1','$2a$10$NgJMuGm5AbT3wDwjiUi18eZ925r4Cat1cp0qi1OYKN2r8jgKJ4L8W','Pozarevac','Srbija','012123211',1,_binary ''),(21,'Pera','Peric','pera@gmail.com','Banjski 2','$2a$10$26sk6WCOfkGDp9nWRaVwxOJjk16QKvI5.K9YL9TVNwOd5C/YhNtl.','Lazarevac','Srbija','06312123211',0,_binary '\0'),(24,'Marija','Tomic','marija@gmail.com','Decanski 21','$2a$10$gO1jFzoQ/FaYC3VVwpAubeHPi0cPD9tjDtvwyBubnMZGVnkGbzQA.','Prizren','Srbija','06432163211',1,_binary '\0'),(37,'Milenko','Marin','milenko@gmail.com','Decanski 21','$2a$10$oZ2XokwdI55NKM0898Zkz.yeAVGb2XxzGIvdKLLRbbrG7PmdsyEiS','Ivanjica','Srbija','06432163211',1,_binary '\0'),(43,'Milivoje','Pesic','milivoje@gmail.com','Decanski 21','$2a$10$cYD2XiVNfDfCNr.HgeyMquEAh7FyhuFKNK3Xi8cyW0DjwHy13nDQi','Srdulice','Srbija','06432163211',1,_binary '\0'),(44,'Pedja','Pesic','pedja@gmail.com','Decanski 21','$2a$10$tT0sQI9n43liawLvmhtxVOZuXvgdz2tbK8SwENC0YFdO3e/Me.6B.','Srdulice','Srbija','06432163211',0,_binary '\0'),(45,'Ivica','ivica','ivica@gmail.com','Ivina 21','$2a$10$PHG0RVsG1vooHZBHF.4aau6T6a8lFETQAwtUj.3aDA02AqYH2b7o6','Subotica','Srbija','066443',0,_binary '\0'),(46,'admin','adminovic','adminklinike','adminovska','$2a$10$jETPwcdlGQAZhriCqlzjSu3BzP.2xbIxlg5v4LiXHMfe9LDUscpcO','admingrad','Adminija','063-219/312',1,_binary '\0'),(47,'Miloran','Mirkovic','milorad@gmail.com','Pupinova 21','$2a$10$N3QCRip57FIBVeEubyl9BeqCB3kSKJHbk1bf3BBJ9UQcFherGVO6O','Beograd','Srbija','063111212',1,_binary '\0'),(48,'Dragana','Dobrilovic','dragana@gmail.com','Drinska 21','$2a$10$CdiKC/4A6uzdqsdAjoredOTXdITLIJ2tZQOMYKvBdoJTrROw4usfy','Beograd','Србија','0622224232',1,_binary '\0'),(49,'Dragan','Ivanovic','dragan@gmail.com','Teslina 24','$2a$10$dXOhs5ghbA4bnuSMwVYSLelEi0M5T5Eq0HQaOPPEr/7wlq1HMxGu2','Pozarevac','Srbija','06322255543',1,_binary '\0'),(50,'Dalibor','Manojlovic','dalibor@gmai.com','Postaja 21','$2a$10$6WKBprUULFLYFJDosTjwx.SRzQAvE6J7J9VzAwtVQjQbDfGCR/D5K','Beograd','Srbija','066555444',1,_binary '\0'),(51,'admincentar','admincentarski','centaradmin','Centarska 30','$2a$10$yv7v/5LH5gURhkZLAvKfieLDIb.up.bYsSWDWo2T52HioLTnlItAm','Novi Sad','Srbija','065-555-555',1,_binary '');
...
INSERT INTO `users_roles` VALUES (1,1),(7,1),(8,1),(9,1),(10,1),(11,5),(12,5),(13,5),(14,5),(15,5),(16,5),(17,5),(18,5),(19,5),(20,5),(21,5),(22,5),(23,5),(24,2),(25,1),(26,1),(27,1),(28,1),(29,1),(30,1),(31,1),(32,1),(33,1),(34,1),(35,1),(36,1),(37,1),(38,1),(43,1),(44,1),(45,5),(46,3),(47,1),(48,2),(49,1),(50,1),(51,4);
...
-- Dump completed on 2021-07-07 23:13:30
