                ...
                <div className="container">
                    <div className="row">
                        <div className="card col-md-6 offset-md-3 offset-md-3">
                            <h3 className="text-center">Patient info</h3>
                            <br></br>
                            <div className="card-body">
                                <form>
                                    ...
                                    <br></br>
                                    <button className="btn btn-success" onClick={this.updateNurse}>Zapocni pregled</button>
                                    <button style={{marginLeft:60+'px'}} className="btn btn-danger" onClick={this.cancel}>Nazad</button>
                                    <button style={{marginLeft:70+'px'}} className="btn btn-success" onClick={this.updateNurse}>Zdravstveni karton</button>             
                                </form>
                            </div>
                        </div>
                    </div>
