...
class CreateNurse extends React.Component {
    constructor(props){
        super(props)
        ...
        this.saveNurse = this.saveNurse.bind(this);
...
saveNurse = (e) =>{
    ...
    let nurse = {firstname: this.state.firstname, lastname: this.state.lastname, username: this.state.username,
                ...
                <div className="container">
                    <div className="row">
                        <div className="card col-md-6 offset-md-3 offset-md-3">
                            <h3 className="text-center">Create Nurse</h3>
                            <div className="card-body">
                                <form>
                                    ...
                                    <button className="btn btn-success" onClick={this.saveNurse}>Save</button>
